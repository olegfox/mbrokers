...
<div class="calculator_all">
  ...
  <div class="face" id="calc1"  style="overflow:auto; height:340px; width:630px;">
    ...
    ?>
      ...
      <div id="substrate" onmouseup="substrate_izmen(this);">

        <input type="radio" class="styled0" id="typ" name="typ" value="<?php echo $row['id'];?>"><?php echo $row["type"];?>
