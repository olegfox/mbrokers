...
massInfo[10]=result;
/*document.getElementById('calc11').innerHTML="Стоимость ОСАГО<br>"+"typ="+typ+"<br>"+"tb="+tb+"<br>"+"kt="+kt+"<br>"+"kbm="+kbm+"<br>"+"ko="+ko+"<br>"+"ks="+ks+"<br>"+"km="+km+"<br>"+"kvs="+kvs+"<br>"+"kn="+kn+"<br>"+"kp="+kp+"<br>";*/
//alert(result);
